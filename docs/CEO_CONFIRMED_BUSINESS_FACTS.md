# CEO Confirmed Business Facts

**Fecha:** 2026-09-12
**Autoridad:** Iván Quea — CEO / Product Owner
**Propósito:** registrar hechos/configuraciones confirmados directamente por el CEO para evitar que análisis posteriores reintroduzcan supuestos incompatibles.
...
## Calendario y servicio — CEO_CONFIRMED
- Opera **6 días por semana**: miércoles, jueves, viernes, sábado, domingo y lunes.
- **Martes = PLANNED_CLOSED / descanso. Nadie trabaja martes.**
- Atención desde 16:00.
- Servicio en mesa hasta 23:00.
- Para llevar hasta 23:30.
- Después del cierre comercial, el personal limpia únicamente su sector/puesto antes de retirarse.
- Un martes cerrado nunca se trata como falla, cierre no planificado ni pérdida de disponibilidad.

## Roles actuales/futuros — CEO_CONFIRMED / CEO_PROPOSED
- Iván debe quedar fuera del trabajo operativo de VANSAM; función CEO/supervisión remota.
- Samira actualmente cubre administración, masa, compras/abastecimiento y hamburguesas viernes/sábado/domingo.
- Objetivo futuro: Samira deja de ser operativamente crítica y queda como socia/supervisora.
- Hornero/armador futuro: arma, hornea, prepara toppings/mise en place y mantiene limpio su sector. Salario propuesto: Bs 3.300 (`CEO_PROPOSED`).
- Masa: por ahora la prepara Samira antes de apertura; receta propia reservada.
- Mesera/cajera futura: trabaja desde apertura hasta cierre, 6 días; responsable de caja/sala, bebidas, aderezos, reposición visible, orden y limpieza de sala. Pago propuesto Bs 1.800–2.000 sujeto a jornada/compliance (`CEO_PROPOSED`).
- Futuro administrador/a: reemplazará progresivamente la administración operativa de Samira.

## Dispositivos — CEO_CONFIRMED
- Pantalla táctil 23": caja/mesera, POS y funciones operativas principales.
- Pantalla 13" cocina: más lenta; usar principalmente como KDS/visualización simple de pedidos pizza/hamburguesa.
- TV 42": pantalla cliente, confirmación visual de pedido, ofertas/cross-sell con aprobación del cliente.

## Incidencias — CEO_CONFIRMED
- Trabajadores deben poder reportar incidencias/reclamos operativos.
- Reporte futuro posible por WhatsApp autenticado/vinculado a identidad.
- El sistema debe saber quién reporta y contra qué proceso/responsable se dirige.
- Responsable funcional no equivale automáticamente a culpable.
- Samira puede ver incidencias, pero no editarlas ni eliminarlas.
...
Cadena real a soportar:
1. evaluar/fijar terreno;
2. invertir en desmonte/preparación;
3. definir superficie/hectáreas;
4. comprar/producir plantines y plantar;
5. deshierbes periódicos;
6. fumigaciones/manejo según necesidad;
...
1. torrado base: aprox. Bs 50–60/kg;
2. torrado premium: aprox. Bs 80/kg;
3. especial base: aprox. Bs 120/kg;
4. especial premium: aprox. Bs 160/kg.

- Cuatro envases claramente diferenciables, potencialmente por colores.
- Precios todavía deben validarse contra costo, canal y presentación antes de marcarlos como vigentes.

## Activos móviles — CEO_CONFIRMED
- Toyota Hiace 1982: mecánicamente en buen estado, pendiente de laminado/adaptación para trabajo comercial.
- Ford Ranger 2008 de un hermano de Iván: posible unidad de venta operada por él.
- Propiedad familiar del vehículo debe permanecer separada de propiedad empresarial.
...
- También se comercializa cocoa/polvo y cascarilla de cacao, además de otros derivados futuros.
- Debe soportar múltiples formulaciones, lotes, modelos, formas, pesos, presentaciones y precios sin mezclar datos.
...
# IQ GROWTH — UNIVERSALIDAD

## CEO_CONFIRMED
- IQ GROWTH debe prestar servicio a **numerosos rubros y negocios pequeños, medianos o grandes**.
- Debe soportar empresas formales, informales y en transición, registrando realidad sin mezclarla con validación jurídica.
