...
INSERT INTO iqg_core.precio_vigente (
    ...
    'a1000000-0000-4000-8000-000000000001', 'BOB', 120, '2027-02-01 00:00:00+00',
    'a1100000-0000-4000-8000-000000000001', 'QA_PRECIO_SUCESOR_B',
    'a1100000-0000-4000-8000-000000000022', 'QA_PRUEBA'
);
COMMIT;
